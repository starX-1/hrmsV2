...
import { getDepartmentLeaveRequests, processLeaveRequestDecision } from '@/app/api/leave';
...
export default function TeamLeaveRequestsPage() {
    ...
    const fetchRequests = async () => {
        setIsLoading(true);
        try {
            const response = await getDepartmentLeaveRequests();
    ...
    const handleOpenCommentModal = (request: LeaveRequest) => {
    ...
    const handleSubmitComment = async (e: React.FormEvent) => {
        ...
        try {
            await processLeaveRequestDecision(selectedRequest.id, { employeeId: selectedRequest.employeeId, action: 'comment', comment });
    ...
    const filteredRequests = requests.filter(req => {
        const matchesSearch =
            ...
            req.employee.department.name.toLowerCase().includes(searchTerm.toLowerCase());
        ...
        <div className="min-h-screen bg-gray-50 p-4 md:p-6 lg:p-8">
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-8">
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-8">
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900 mb-2">Team Leave Requests</h1>
                            <p className="text-gray-600">Manage and review leave requests from your department</p>
                        </div>
                            ...
                            <table className="w-full">
                                <thead>
                                    <tr className="bg-gray-50">
                                        ...
                                        <th className="py-3 px-6 text-left text-sm font-semibold text-gray-700">Comments</th>
                                        ...
                                        <tr key={req.id} className="hover:bg-gray-50 transition-colors">
                                            <td className="py-4 px-6">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="text-sm text-gray-500">{req.employee.department.name}</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="py-4 px-6">
                                            ...
                                            <td className="py-4 px-6">
                                                <div className="max-w-xs">
                                                    <span className={`text-sm ${req.managerComment ? 'text-gray-700' : 'text-gray-400 italic'}`}>
                                                        {req.managerComment || 'No comments yet'}
                                                    </span>
                                                </div>
                                            </td>
                                            <td className="py-4 px-6">
                                                <div className="flex gap-2">
                                                    <button
                                                        onClick={() => handleOpenCommentModal(req)}
                                                    ...
                                                    >
                                                        ...
                                                        {req.managerComment ? 'Edit' : 'Comment'}
                                                    </button>
                                                </div>
                                            </td>
                                        </tr>
            ...
            {isCommentModalOpen && selectedRequest && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 ">
                    {/* Black/50 background as requested */}
                    <div
                    ...
                    <div className="relative bg-white max-h-[90vh] overflow-y-auto flex flex-col rounded-xl w-full max-w-md mx-auto transform transition-all duration-200 shadow-2xl">
                        ...
                        <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between bg-gray-50 rounded-t-xl">
                            <div>
                                <h3 className="text-lg font-semibold text-gray-900">Add Manager Comment</h3>
                                <p className="text-sm text-gray-500">Provide feedback on this leave request</p>
                            </div>
                            <button
                        ...
                        <form onSubmit={handleSubmitComment} className="flex flex-col flex-1 min-h-0">
                            <div className="p-6 overflow-y-auto">
                                ...
                                <div className="mb-6 bg-gray-50 rounded-lg p-4 border border-gray-200">
                                    <div className="flex items-center gap-3 mb-4">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-sm text-gray-500">{selectedRequest.employee.department.name}</div>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center justify-between mt-2">
                                        <p className="text-xs text-gray-500">This comment will be visible to the employee and HR</p>
                            ...
                            <div className="px-6 py-4 border-t border-gray-200 bg-gray-50 flex items-center justify-end gap-3 rounded-b-xl flex-none">
                                ...
                                <button
                                    type="submit"
                                    disabled={isSubmitting || comment.length > 500}
                                    className="px-4 py-2 text-sm font-medium text-white bg-green-600 hover:bg-green-700 rounded-lg shadow-sm hover:shadow transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                                >
                                    {isSubmitting ? (
                                        <>
